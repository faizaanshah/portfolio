...
const blogPosts = [
  {
    ...
    description:
      "There can be multiple ways of moving PostgreSQL databases, but I'll be explaining AWS Database Migration...",
  },
  {
    image: blog2,
  ...
  {
    image: blog3,
    title: "WIFI Icon not showing on Ubuntu 20.04 and cannot connect to network",
    link: "https://medium.com/@faizanshah801/wifi-icon-not-showing-on-ubuntu-20-04-and-cannot-connect-to-network-a271c167bd8d",
    description:
      "With a recent update I found out that I no longer had a WIFI option in my networks and wasn’t able to connect. ...",
  },
  {
    image: blog4,
    ...
    description:
      "In order to setup a jenkins server over the AWS you need to have an AWS account. Once you have the account you can setup the server ...",
  },
  {
    image: blog5,
    title: "Updating AWS ECS Taskdefintions and Services via Ansible",
